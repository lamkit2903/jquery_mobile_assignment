...
<div id="choose_drug" data-role="page">
	...
	<div align="center">
	<h1> Lamictal </h1>
	<img width="250px" src="images/Lamictal.jpg"></img>
	</div>
	<ul data-role="listview" data-inset="true" >
	<li><a href="" id="btn1"><h2>Overivew</h2></a></li>
	<div id="content1">
	<h2>Lamictal (lamotrigine) is an anti-epileptic </h2>
	<h2>medication, also called an anticonvulsant.</h2>
	<h2></h2>
	<h2>Lamictal is used either alone or in combination </h2>
	<h2>with other medications to treat epileptic seizures </h2>
	<h2>in adults and children. Lamotrigine is also used to </h2>
	<h2>delay mood episodes in adults with bipolar </h2>
	<h2>disorder (manic depression).</h2>
	</div>
	...
	<script>
		$(document).ready(function() {
			$("#yes").click(function() {
				...
				var list = "<li><a href=\"Lamictal.php\" rel=\"external\" id=\"list_6\"> Lamictal </a></li>";
