...
<div id="choose_drug" data-role="page">
	...
	<div align="center">
	<h1> Baclofen </h1>
	<img width="250px" src="images/Baclofen.jpg"></img>
	</div>
	<ul data-role="listview" data-inset="true" >
	<li><a href="" id="btn1"><h2>Overivew</h2></a></li>
	<div id="content1">
	<h2>Baclofen is a muscle relaxer and an antispastic agent.</h2>
	<h2>Baclofen is used to treat muscle symptoms caused by multiple </h2>
	<h2>sclerosis, including spasm, pain, and stiffness.</h2>
	<h2>Baclofen may also be used for purposes not listed in this </h2>
	...
	<ul>
		...
		<li>mental depression or other mood changes</li>
	...
	<h2>How it works</h2>
	<h2></h2>
	<h3>Experts are not sure how baclofen works to </h3>
	<h3>relieve muscle spasms but suggest it works </h3>
	<h3>directly on nerve impulses in the spine.</h3>
	</div>
	</ul>	
	</div>
	<?php
	...
	<script>
		$(document).ready(function() {
			$("#yes").click(function() {
				...
				var list = "<li><a href=\"Baclofen.php\" rel=\"external\" id=\"list_3\"> Baclofen </a></li>";
